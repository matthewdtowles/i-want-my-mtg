...
/**
 * Native IWMM "import an entire set" CSV format. One row per set; each adds
 * all cards from that set to the user's inventory at quantity 1 (or foil
 * variants when `foil=true`).
 */
